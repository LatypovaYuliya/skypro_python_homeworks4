...
@pytest.mark.parametrize('word , result', [("skypro", "Skypro"),
...
@pytest.mark.parametrize('string, symbol, result', [("SkyPro", "SP", True),
                         ("Test", "oo", True)])
...
@pytest.mark.parametrize('string, symbol, result', [("SkyPro", "N", False),
                         ("Test", "h", False)])
...
@pytest.mark.parametrize('string, symbol, result', [("SkyPro", "y", "SkPro"),
                         ("Test", "e", "Tst")])
...
@pytest.mark.parametrize('string, symbol, result', [("SkyPro", "Y", "SkyPro"),
                         ("Test", "E", "Test")])
